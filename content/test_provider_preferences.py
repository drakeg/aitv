...
class ProviderPreferenceTests(TestCase):
    ...
    def test_provider_personalization_documentation_tracks_current_behavior(self):
        ...
        self.assertIn('docs/coding-standards.md', readme)
        self.assertIn('docs/sprints.md', readme)
        self.assertIn('docs/live-tv-epg.md', readme)
        self.assertTrue((Path(settings.BASE_DIR) / 'docs' / 'coding-standards.md').exists())
        self.assertTrue((Path(settings.BASE_DIR) / 'docs' / 'sprints.md').exists())
        self.assertTrue((Path(settings.BASE_DIR) / 'docs' / 'live-tv-epg.md').exists())
